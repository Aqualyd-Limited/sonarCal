"""Provides functions to read files generated by Simard SN90 and CS90 sonars.

This file is a modified version of a file of the same name in the pyEcholab repository,
available at https://github.com/noaa-afsc-mace/pyEcholab (see the echolab2/instruments/util
directory). See that file for the licence details and author acknowledgements.

A class defined here, RawSimradFile, provides a low-level interface to the datagrams
in Simrad's .raw file format. The datagram concept is the same as in Simrad echosounder
